...
const Contact = () => {
  return (
    <div className="mt-5 md:mt-18 ">
      ...
      <div className="flex flex-col p-2 space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
